...
set(CMAKE_AR "${EMSCRIPTEN_ROOT_PATH}/emar${EMCC_SUFFIX}" CACHE FILEPATH "Emscripten ar" FORCE)



set(CMAKE_RANLIB "${EMSCRIPTEN_ROOT_PATH}/emranlib${EMCC_SUFFIX}" CACHE FILEPATH "Emscripten ranlib" FORCE)
...
set_property(GLOBAL PROPERTY "-Wno-warn-absolute-paths")
include_directories( lib/emscr/IzLib/include )

#set(CMAKE_RUNTIME_OUTPUT_DIRECTORY "${CMAKE_SOURCE_DIR}/web/lib")
#add_executable(EmInstance lib/emscr/IzLib/src/Iz_Em_Instance.cc lib/emscr/IzLib/src/Iz_Message.cc)
#set_target_properties(EmInstance PROPERTIES LINK_FLAGS "-Oz -s EXPORTED_FUNCTIONS=\"['_main','_ReceiveMessage','_initConverter']\" -s NO_EXIT_RUNTIME=1 -s DISABLE_EXCEPTION_CATCHING=0")


add_library(
    Iz_EmLib
    STATIC
    lib/emscr/IzLib/src/Iz_EmLib.cc lib/emscr/IzLib/src/Iz_Message.cc lib/emscr/IzLib/src/Iz_Em_FileSystem.cc
    lib/emscr/IzLib/include/Iz_EmLib.h lib/emscr/IzLib/include/Iz_Message.h lib/emscr/IzLib/include/Iz_Em_FileSystem.h
)


foreach(PROGRAM ${EMSCR_PROGRAMS})

message( "Building converter : ${PROGRAM}" )
set(CMAKE_RUNTIME_OUTPUT_DIRECTORY "${CMAKE_SOURCE_DIR}/web/converters/${PROGRAM}/bin")
file(GLOB_RECURSE SOURCE_FILES ${CMAKE_SOURCE_DIR}/web/converters/${PROGRAM}/emscr/*.cc)


add_executable(${PROGRAM} ${SOURCE_FILES} )

set_target_properties(${PROGRAM} PROPERTIES LINK_FLAGS "-Oz -s EXPORTED_FUNCTIONS=\"['_initWorker','_updateDownloadProgress','_sendOutputUrl','_workerReady','_prerunRequest']\" -s ALLOW_MEMORY_GROWTH=1 -s BUILD_AS_WORKER=1 -s MEMFS_APPEND_TO_TYPED_ARRAYS=1")
